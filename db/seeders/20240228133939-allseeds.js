...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Users', [
      {
        username: 'Иванов Иван Иванович', email: "lol@mail.ru", districtId: 2,
      },
      {
        username: 'Иванова Мария Ивановна', email: "lola@mail.ru", districtId: 6,
      },
      {
        username: 'Шляпников Иван Владимирович', email: "lolaland@mail.ru", districtId: 7,
      },
